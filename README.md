...
Este repositório reúne os **códigos, scripts e arquivos de apoio** utilizados nos experimentos do artigo:

***“Uma Comparação das Ferramentas Open Source de CLI para Geração de Ataques DDoS em Ambientes de Internet”***

O repositório também inclui a **tabela completa com a descrição das anomalias de tráfego** avaliadas no trabalho, bem como arquivos auxiliares usados na coleta e no processamento dos resultados.
...
* calculo da duração das simulações.
