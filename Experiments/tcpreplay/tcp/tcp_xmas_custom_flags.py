...
def run_tcp_xmas_custom_flags():
    ...
    while True:
        ...
        tcp_layer = TCP(sport=RandShort(), dport=TARGET_PORT, flags="FUP", seq=seq_num, window=8192) # CUSTOM FLAGS
    ...
    wrpcap("tcp_xmas_custom_flags.pcap", lista_de_pacotes)
